...
def load_data():
    ...
    df = df.rename({'ConvertedCompYearly': 'Salary', 'YearsCodePro':'Experience', 'EdLevel':'Education'}, axis=1)
...
def show_explore_page():
    ...
    data = df.groupby('Experience')['Salary'].mean().sort_values(ascending=False)
    st.line_chart(data)
